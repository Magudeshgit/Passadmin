...
urlpatterns = [
    ...
    path('About/', v.About),
    path('Home_About/', views.About),
    path('Why_us/', v.Why_us),

    path('login/',v.loginpg, name="login"),
    path('logout/', v.logoutuser, name="logout"),
    path('register/', v.CreatePage, name="Register"),
    
    path('Addpassword/', views.home),
    path('Vault/',views.Passwords, name="Passwords"),
    ...
    path('reset_password_complete/', auth_views.PasswordResetCompleteView.as_view(template_name="register/reset-complt.html"), name="password_reset_complete"),
]
